...
import isomap.common.RepaintingObserver;
import isomap.common.SelectionModel;
import isomap.datastores.DataStore;
import isomap.input.TilemapMouseAdapter;
import isomap.input.ViewportMouseAdapter;
import isomap.io.SimpleTerrainLoader;
import isomap.io.TerrainLoader;
import isomap.io.TileSetBuilder;
import isomap.io.TileSetBuilderWesnoth;
...
import isomap.tile.model.HexTileModel;
import isomap.tile.model.IsoTileModel;
import isomap.tile.model.TileModel;
import isomap.view.TileRendererCursor;
import isomap.view.TileRendererDefault;
import isomap.view.TileRendererGrid;
...
public class ExampleComponent extends JComponent {
    ...
    public ExampleComponent(DataStore dao) throws IOException {
        ...
        TerrainLoader terrainLoader = new SimpleTerrainLoader();
...
//        terrainModel = new HexTileModel(terrainData.getWidth(), terrainData.getHeight(), tileset);
        terrainModel = new IsoTileModel(terrainData.getWidth(), terrainData.getHeight(), tileset);
