...
/**
 * Contains a set of selected elements and notifies attached {@link Observer}s
...
public class SelectionModel<T> extends Observable {
     ...
     *
     * @param elements
     *            a set of elements that will become the new selection
     */
    ...
    /**
     * Clear the selection. Notifies only if selection is changed
     */
    public void clear() {
